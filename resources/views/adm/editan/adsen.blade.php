...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Adsen Page</h1>
    ...
    <div class="col-xl-12 col-lg-7">
      <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Adesense</h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
          *klik source
          <form method="POST" action="/home/{{$data->id}}/updateadsen">
            @csrf
          <textarea class="form-control" id="adsen" name="adsen">{{$data->adsen}}</textarea>
        </div>
