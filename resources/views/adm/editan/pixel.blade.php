...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Pixel Seo FB</h1>
  ...
  <div class="row">
    ...
    <div class="col-xl-12 col-lg-7">
      <div class="card shadow mb-4">
        ...
        <!-- Card Body -->
        <div class="card-body">
          <form method="POST" action="/home/{{$data->id}}/updatepixel">
            @csrf
          <textarea class="form-control" id="pixel" name="pixel">{{$data->pixel}}</textarea>
        </div>
