...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Privacy Page</h1>
  ...
  <div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <textarea class="form-control" readonly>{!! $pv->privacy !!}</textarea>
      </div>
      <div class="modal-footer">
         <a href="/home/privacy/{{$pv->id}}/get"><button type="submit" class="btn btn-primary">Update!</button></a>
        </form>
      </div>
        @endforeach
    </div>
