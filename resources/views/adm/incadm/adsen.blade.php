...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Adsense Page</h1>
...
<div class="row">
  ...
  <div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        @foreach($adsen as $ad)
        <textarea class="form-control" readonly>{!! $ad->adsen !!}</textarea>
      </div>
      <div class="modal-footer">
         <a href="/home/adsen/{{$ad->id}}/get"><button type="submit" class="btn btn-primary">Update!</button></a>
        </form>
      </div>
        @endforeach
    </div>
